...
credit_data = credit_data[~(credit_data["Transaction Date"] < "2019-1-1")]
credit_data = credit_data[~(credit_data["Transaction Date"] > "2020-1-1")]

checking_data = checking_data[~(checking_data["Transaction Date"] < "2019-1-1")]
checking_data = checking_data[~(checking_data["Transaction Date"] > "2020-1-1")]

savings_data = savings_data[~(savings_data["Transaction Date"] < "2019-1-1")]
